      ...
      <div class="row">
          <div class="col-lg-6">
               <div class="card mb-3">
                ...
                <div class="card-body">
                     <form method="post" id="teacherChangePassForm">
                ...
                <div class="card-footer small text-muted" id="teacherChangePassMes">
          ...
          <div class="col-lg-6">
               <div class="card mb-3">
                ...
                <div class="card-body">
                    <form method="post" id="teacherContactForm">
                        ...
                        <button class="btn btn-success form-control" id="teacherContactBtn"><i class="fa fa-paper-plane-o  fa-lg"></i></button> 
                    </form>
                </div>
                <div class="card-footer small text-muted" id="teacherContactMes">
